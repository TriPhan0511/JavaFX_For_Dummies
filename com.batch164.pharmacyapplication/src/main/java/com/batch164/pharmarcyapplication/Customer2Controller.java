...
import com.batch164.pharmarcyapplication.utils.dao.CustomerDAO;
...
//  ------- Belows are the individual fields and methods for customer scene ----------
  ...
  @FXML
  private void add2Button_Click(ActionEvent event) throws IOException
  {
//    Switch stage:
//    Get "customer-adding-view"
    FXMLLoader loader = new FXMLLoader(
        getClass().getResource("customer-adding-view.fxml"));
    Parent root = loader.load();
    Scene customerAddingScene = new Scene(root);

//    Get reference to the primary stage
    Stage primaryStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    primaryStage.setScene(customerAddingScene);
    primaryStage.show();

////    Create a new stage
//    Stage stage = new Stage();
//    stage.setScene(customerAddingScene);
//    stage.show();
  }
//  ---------------- END OF NEW----------------------------
...
//  ------------------------ NEW -------------------------------
  ...
  public void setDataForListView(ObservableList<Customer> data)
  {
...
//    customerListView.setItems(CustomerDAO.getCustomers());
